#!/usr/bin/env python3
"""
Reset <slug>/Solution.java to the original starter code from .leetknight.json.
...
def main() -> int:
    ...
    if not os.path.isfile(meta_path):
        print(f"[error] missing {meta_path}. Re-scaffold with 'LeetKnight: New Problem'.", file=sys.stderr)
        return 1
