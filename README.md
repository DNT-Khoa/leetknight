<div align="center">
  <img src="media/icon.png" alt="LeetKnight" width="128"/>
  <h1>LeetKnight</h1>
...
4. **Practice later** — open the **LeetKnight** activity-bar entry. Your solved problems are grouped by rating with hardest at the top. Click any row to re-solve (silent reset to starter). Or click the random-pick button for interview mode.
